...
export default function Login({navigation}) {
  ...
  async function logincall(dispatch){
    ...
    await axios.post('https://ptrlpump-backend.herokuapp.com/api/login/',{
      "username": Id,
      "password": Password
    }).then((response) => {
  ...
  function handleVisibility(){
    ...
    return (
      <View style={styles.container}>
        ...
        <Pressable onPress={()=>logincall(dispatch)} style={[styles.pressablestyle,{borderColor:'#0088ff'}]}>
